...
<body>
    <div class="full-page">
        <div class='navbar'>
            <div class='logo'>
                <a href='#'><h1>Cardiovascular Risk Calculator</h1></a>
            </div>
            <nav>
                <ul id='MenuItems'>
        ...
        <div class="sub-page">
          <div class="overlay"></div>
           <div class="text" >
               <h4> <p> A healthy heart <br> will give you the courage to face and overcome <br>any challenge in life <br>"Start From The Healthy Heart" </p> </h4>
            </div>
        </div>
